  ...
  return (
    <div className="border-b border-amber-500/20 bg-amber-500/10">
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-6 py-2 text-sm">
        ...
        <p className="flex-1 text-amber-200/90">
          ...
          Supabase keys to <code className="rounded bg-black/20 px-1">.env.local</code> for
        ...
        <button
          ...
          className="rounded p-1 text-amber-200/70 transition hover:bg-amber-500/10 hover:text-amber-100"
